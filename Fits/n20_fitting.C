...
void n20_fitting(string root_file_name,string map_file)
{
  ...
  sprintf(path2,"Results/n20/v1");//,root_file_name.c_str());
  ...
  std::ofstream file;
  file.open("fit_function_parameters_n20_updatedntuples_v2.txt",ios::out);
  ...
  for(int iModule = 0; iModule<(int(map_vec.size()));iModule++)
    {  average_per_elinks_Map map;
      ...
      sprintf(hist_name,"orig_hits_20_%d_%d_%d_%d",map_vec[iModule].layer,map_vec[iModule].type,map_vec[iModule].u,map_vec[iModule].v);
       ...
       //if(hist_name!="orig_hits_20_2_1_8_9") continue;
       if(resp->GetMean()==0.0)
	 {
	   
	   file<<iModule<<"\t"<<map_vec[iModule].layer<<"\t"<<map_vec[iModule].u<<"\t"<<map_vec[iModule].v<<"\t"<<map_vec[iModule].type<<"\t"<<0<<"\t"<<0<< "\t"<<0<<"\t"<<0<<"\t"<<0<<"\t"<<0<<"\t"<<0<<"\t"<<0<<"\n";
	   continue;
	 }
       //       if((map_vec[iModule].layer==40 && map_vec[iModule].u ==2 && map_vec[iModule].v==7 )) {
      if(map_vec[iModule].u<=5 && map_vec[iModule].v<=5)
 	  ...
 	  if(map_vec[iModule].layer<=6){
 	...
 	else if( map_vec[iModule].layer>6 && map_vec[iModule].layer<=10)
 	    {
 	      ...
 	      resp2->GetXaxis()->SetTitle("number of hits");
 	      resp2->GetXaxis()->SetTitleSize(0.05);
 	      //resp2->GetXaxis()->SetLimits(0,400);
 	      resp2->SetLineColorAlpha(kRed,1);
 	      resp2->SetMarkerColor(kRed);
 	      resp2->SetLineWidth(2);
	...
	//if ((map_vec[iModule].u>=6 && map_vec[iModule].u<=8) && (map_vec[iModule].v>=6 &&map_vec[iModule].v<=8)) 
      	{
      	  if(map_vec[iModule].layer<=2)
      	  ...
      	  else if(map_vec[iModule].layer<=10 && map_vec[iModule].layer>=3)
      	    {
      	      ...
      	      TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
      	      //TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::GammaDist(x,[6],0,1)");
	      if(map_vec[iModule].layer==5 && map_vec[iModule].u ==8 && map_vec[iModule].v==8)
                {
		   func->SetParameter(0,2500); // set starting values                                                                                               
              ...
              func->SetParameter(4,resp2->GetMean());
              func->SetParameter(5,2000);
              func->SetParameter(6,0.1*resp2->GetMean());//-0.5*resp2->GetMean());                                                                                        
              func->SetParameter(7,resp2->GetRMS());
	      ...
	      else
		{
      	  ...
      	  else if(map_vec[iModule].layer>=22 && map_vec[iModule].layer<=42)
            {
              ...
              resp2->SetLineWidth(2);
              TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
	      if((map_vec[iModule].layer==33 && map_vec[iModule].u ==7 && map_vec[iModule].v==8 ))// || (map_vec[iModule].layer==40 && map_vec[iModule].u ==8 && map_vec[iModule].v==7 ))
		 {
		   func->SetParameter(0,2500); // set starting values                                                                                                    
		   func-> SetParameter(1,resp2->GetMean()-2); // set starting values \
              ...
              func->SetParameter(4,resp2->GetMean());
              func->SetParameter(5,2000);
              func->SetParameter(6,0.5*resp2->GetMean());//-0.5*resp2->GetMean());                                                                                       \
                                                                                                                                                                      
              func->SetParameter(7,0.5*resp2->GetRMS());
	       }

	       else if ((map_vec[iModule].layer==40 && map_vec[iModule].u ==8 && map_vec[iModule].v==7 ))
		 {
		   func->SetParameter(0,250);                                                                                                         
              ...
              func->SetParameter(3,10000);
              func->SetParameter(4,resp2->GetMean());
              func->SetParameter(5,20000);
              func->SetParameter(6,0.5*resp2->GetMean());                                                                                   
              func->SetParameter(7,0.05*resp2->GetRMS());
	  ...
	  if(map_vec[iModule].layer<=13&&map_vec[iModule].layer>=1)
	    {
	      ...
	      TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
	      if((map_vec[iModule].layer==2 && map_vec[iModule].u ==8 && map_vec[iModule].v==9))//||(map_vec[iModule].layer==2 && map_vec[iModule].u ==10 && map_vec[iModule].v==5))
		{
		    func->SetParameter(0,2000); // set starting values                                                                                
              func-> SetParameter(1,0.1*resp2->GetMean()); // set starting values                                                                                        
              func->SetParameter(2,resp2->GetRMS());
              func->SetParameter(3,10000);
              func->SetParameter(4,resp2->GetMean());
              func->SetParameter(5,5000);
		...
		// else if (map_vec[iModule].layer==2 && map_vec[iModule].u ==10 && map_vec[iModule].v==5)
	      // 	  {
	      // 	         func->SetParameter(0,2000); // set starting values                                                                             
              // func-> SetParameter(1,0.1*resp2->GetMean()); // set starting values                                                                                   
              // func->SetParameter(2,resp2->GetRMS());
	      ...
	      else
		{
	      ...
	      Canvas_n2->SaveAs(full_path2);
	  ...
	  else  if(map_vec[iModule].layer<=19 && map_vec[iModule].layer>=14)
            {
              ...
              TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
	      if((map_vec[iModule].layer==18 && map_vec[iModule].u ==9 && map_vec[iModule].v==5) ||( map_vec[iModule].layer==18 && map_vec[iModule].u ==4 && map_vec[iModule].v ==9 ))
		{
		   func->SetParameter(0,1000);
		   func-> SetParameter(1,resp2->GetMean());
		   func->SetParameter(2,resp2->GetRMS());
		   func->SetParameter(3,10000); func->SetParameter(4,resp2->GetMean());
		   func->SetParameter(5,5000);
		   func->SetParameter(6,0.1*resp2->GetMean());
		    func->SetParameter(7,0.1*resp2->GetRMS());
		}
	      else
		{
              func->SetParameter(0,1000); // set starting values                                                                                                                                          
	      ...
	      if(r1<0){
	    ...
	    else if(map_vec[iModule].layer<=25 && map_vec[iModule].layer>=20)
            {
              ...
              TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
	      if((map_vec[iModule].layer==24 && map_vec[iModule].u ==10&& map_vec[iModule].v==5)||(map_vec[iModule].layer==25 && map_vec[iModule].u ==9 && map_vec[iModule].v==5))// || (map_vec[iModule].layer==25 && map_vec[iModule].u ==9 && map_vec[iModule].v==5) )                                    
                {
                    func->SetParameter(0,200); // set starting values                                                                                                
              func-> SetParameter(1,resp2->GetMean()); // s
              func->SetParameter(2,resp2->GetRMS());
              func->SetParameter(3,1000000);
              func->SetParameter(4,resp2->GetMean());
              func->SetParameter(5,5000);
              func->SetParameter(6,0.2*resp2->GetMean());//                                                              
              func->SetParameter(7,0.1*resp2->GetRMS());

                }
	      // else if (map_vec[iModule].layer==25 && map_vec[iModule].u ==9 && map_vec[iModule].v==5)
	      // 	{
	      // 	  func->SetParameter(0,20);
	      // 	  func-> SetParameter(1,0.5*resp2->GetMean());
	      // 	  func->SetParameter(2,0.1*resp2->GetRMS()); func->SetParameter(3,10000);
	      // 	  func->SetParameter(4,resp2->GetMean());
	      // 	    func->SetParameter(5,50000);
	      // 	     func->SetParameter(6,0.5*resp2->GetMean());
	      // 	     func->SetParameter(7,resp2->GetRMS());
	       ...
	       else
		 {
	    ...
	    else if(map_vec[iModule].layer<=35 && map_vec[iModule].layer>=26)
            {
              ...
              TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
	      if((map_vec[iModule].u==5 && map_vec[iModule].v ==11 && map_vec[iModule].layer==28) ||(map_vec[iModule].u==10 && map_vec[iModule].v ==7 && map_vec[iModule].layer==30)|| (map_vec[iModule].u==5 && map_vec[iModule].v ==10 && map_vec[iModule].layer==32))
		{
		  func->SetParameter(0,110); // set starting values
		  func-> SetParameter(1,resp2->GetMean()-2); // set starting values                                                                                              
              func->SetParameter(2,resp2->GetRMS()-2);
              func->SetParameter(3,10000);
              func->SetParameter(4,resp2->GetMean());
	      ...
	      else if ((map_vec[iModule].layer==26 && map_vec[iModule].u ==10 && map_vec[iModule].v==2) )//|| (map_vec[iModule].layer==34 && map_vec[iModule].u ==6 && map_vec[iModule].v==9) )
                {
                  func->SetParameter(0,0.01);
                  func-> SetParameter(1,0.01*resp2->GetMean());
                  func->SetParameter(2,0.1*resp2->GetRMS()); func->SetParameter(3,1000000);
                  func->SetParameter(4,resp2->GetMean());
                    func->SetParameter(5,500000);
                     func->SetParameter(6,0.5*resp2->GetMean());
                     func->SetParameter(7,resp2->GetRMS());

                }
	      else if(map_vec[iModule].layer==34 && map_vec[iModule].u ==6 && map_vec[iModule].v==9)
		{
		  func->SetParameter(0,100000);
                  func-> SetParameter(1,0.01*resp2->GetMean());
                  func->SetParameter(2,0.1*resp2->GetRMS());
		  func->SetParameter(3,100000);
                  func->SetParameter(4,0.1*resp2->GetMean());
		  func->SetParameter(5,500);
		  func->SetParameter(6,0.005*resp2->GetMean());
		  func->SetParameter(7,0.001*resp2->GetRMS());
	      ...
	      else
		{
	      ...
	      Mean_G[iModule]=f_l->GetParameter(1);
	    ...
	    else if(map_vec[iModule].layer<=50 && map_vec[iModule].layer>=36)
            {
              ...
              TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
	      // if(map_vec[iModule].layer==40 && map_vec[iModule].u==8 && map_vec[iModule].v==7)
	      // 	{
	      // 	   func->SetParameter(0,10); // set starting values                                                                                                     \

              // func-> SetParameter(1,0.5*resp2->GetMean()); // set starting values
              // func->SetParameter(2,0.5*resp2->GetRMS());
              // func->SetParameter(3,10000);
              // func->SetParameter(4,resp2->GetMean());
              // func->SetParameter(5,5000);
              // func->SetParameter(6,resp2->GetMean()-2);
	   ...
	   if((map_vec[iModule].u<=5 &&(map_vec[iModule].v==6||map_vec[iModule].v==7||map_vec[iModule].v==8))||(map_vec[iModule].v<=5 &&(map_vec[iModule].u==6||map_vec[iModule].u==7||map_vec[iModule].u==8)))
	    {
	      if(map_vec[iModule].layer<=24)
	      	// if(map_vec[iModule].layer<=0)
	      	{
	      	  ...
	      	  TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
		  if(map_vec[iModule].layer==24 && map_vec[iModule].u ==3 && map_vec[iModule].v==8)
		    {
		      func->SetParameter(0,10);
		      func-> SetParameter(1,resp2->GetMean());
		      func->SetParameter(2,resp2->GetRMS());
		      func->SetParameter(3,10000);
		      func->SetParameter(4,resp2->GetMean());func->SetParameter(5,10000);func->SetParameter(6,0.5*resp2->GetMean());
		      func->SetParameter(7,0.5*resp2->GetRMS());
		    }
		  else
		    {
	      ...
	      else if(map_vec[iModule].layer>=31 &&map_vec[iModule].layer<=36)
	      	{
	      	  ...
	      	  gStyle->SetOptFit(111111);
	      	      ...
	      	      resp2->GetXaxis()->SetTitle("number of hits");
	      	      resp2->GetXaxis()->SetTitleSize(0.05);
	      	      //resp2->GetXaxis()->SetLimits(0,400);	      	      resp2->SetLineColorAlpha(kRed,1);
	      	      resp2->SetMarkerColor(kRed);
	      	      resp2->SetLineWidth(2);
	      	      TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
		      if((map_vec[iModule].layer==33 && map_vec[iModule].u ==1 && map_vec[iModule].v==7 )|| (map_vec[iModule].layer==35 && map_vec[iModule].u ==1 && map_vec[iModule].v==7 ))
			{
			 func->SetParameter(0,1000); // set starting values                                                                                              
                      func-> SetParameter(1,resp2->GetMean()); // set starting values                                                                                 
                      func->SetParameter(2,resp2->GetRMS());
                      func->SetParameter(3,10000);
                      func->SetParameter(4,resp2->GetMean());
                      func->SetParameter(5,15500);
                      func->SetParameter(6,0.5*resp2->GetMean());//-0.5*resp2->GetMean());                                                                                
                      //func->SetParameter(6,resp2->GetMean());                                                                                                       
                      func->SetParameter(7,0.5*resp2->GetRMS());

		      }
		      else if((map_vec[iModule].layer==34 && map_vec[iModule].u ==8 &&  map_vec[iModule].v==1 ) || (map_vec[iModule].layer==36 && map_vec[iModule].u ==8 &&  map_vec[iModule].v==3 ))
			{
			  func->SetParameter(0,10); // set starting values                                                                                                                                                                                                                                       
                      func-> SetParameter(1,0.5*resp2->GetMean()); // set starting values                                                                                \
		      ...
		      else if((map_vec[iModule].layer==33 && map_vec[iModule].u ==2 && map_vec[iModule].v==8 ))// ||(map_vec[iModule].layer==34 && map_vec[iModule].u ==6 && map_vec[iModule].v==9 ))
		{
		    func->SetParameter(0,10); // set starting values                                                                                          \
			...
			{
			  func->SetParameter(0,10);
                      func-> SetParameter(1,0.05*resp2->GetMean());	
                      func->SetParameter(2,resp2->GetRMS());
                      func->SetParameter(3,10000);
                      func->SetParameter(4,resp2->GetMean());
                      func->SetParameter(5,40000);
                      func->SetParameter(6,0.05*resp2->GetMean());
                      func->SetParameter(7,0.5*resp2->GetRMS());
	      ...
	      else if (map_vec[iModule].layer>=48)// &&map_vec[iModule].layer<=47)
		{
		  ...
		  TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
		  if(map_vec[iModule].layer==50 && ((map_vec[iModule].u == 3 && map_vec[iModule].v==7)||(map_vec[iModule].u == 6 && map_vec[iModule].v==1)))
		    {
		       func->SetParameter(0,1000); // set starting values                                                                                                                                       
