...
sigma_L_n10=[]
shape_n10=[]
data_n10 = np.loadtxt("./inputs/27June22_fitted_parameters_n10_D49_FeV9_mipDef_v2.txt")
for im in range(4851):
...
sigma_L_n20=[]
shape_n20=[]
data_n20 = np.loadtxt("./inputs/27June22_fitted_parameters_n20_D49_FeV9_mipDef_v2.txt")
...
sigma_L_n30=[]
shape_n30=[]
data_n30 = np.loadtxt("./inputs/27June22_fitted_parameters_n30_D49_FeV9_mipDef_v2.txt")
for im in range(4851):
...
for im in range(4851):
    ...
    #[0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])
    ...
    for i in range(min_,max_):
        gRandom.SetSeed(((i+2)*seed_)/(im+1))
        #gRandom.SetSeed(i)
