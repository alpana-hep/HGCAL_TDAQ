...
const char* legend_text[5]={"n10+=20","n20+=20","n30+=20","nhits+=20","Scale-Off"};//{"10kBX","50kBX","100kBX","200kBX","400kBX","600kBX","800kBX","1000kBX","1500kBX"};
...
int line_style[12] = {1,1,1,9,5,1,1,1,1,1,1,1};
...
void generate_1Dplot(vector<TH1F*> hist, char const *tag_name="", int energy=-1, char const *leg_head="",
 ...
 //gStyle->SetOptFit(0);
  ...
  if(save_canvas) {
    sprintf(canvas_name,"/eos/user/k/kalpana/www/folder/HGCAL_TDAQ/Plots/01Feb2023_EMuStudies_ScalingHits/HitAdditive_DiffNumbers/AddingSameValue/20/%s.png",tag_name);
    c->SaveAs(canvas_name);
    sprintf(canvas_name,"/eos/user/k/kalpana/www/folder/HGCAL_TDAQ/Plots/01Feb2023_EMuStudies_ScalingHits/HitAdditive_DiffNumbers/AddingSameValue/20/%s.pdf",tag_name);
    c->SaveAs(canvas_name);
...
void overlayPlots_v1()
{
  ...
  f3[4]= new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_CMSSW_BX_100k_defaultConfig.root");

  f3[0] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_CMSSW_BX_100k_defaultConfig_hitScaleAdditive_20per_case_51.root");
  f3[1] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_CMSSW_BX_100k_defaultConfig_hitScaleAdditive_20per_case_52.root");
  f3[2] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_CMSSW_BX_100k_defaultConfig_hitScaleAdditive_20per_case_53.root");
  f3[3] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_CMSSW_BX_100k_defaultConfig_hitScaleAdditive_20per_case_5.root");
  ...
  f4[4]= new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_Correlate_Psuedo_BX_100k_defaultConfig.root");
  
f4[0] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_Correlate_Psuedo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_51.root");            
  f4[1] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_Correlate_Psuedo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_52.root");               
  f4[2] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_Correlate_Psuedo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_53.root");                 
  f4[3] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_Correlate_Psuedo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_5.root");                   
  ...
  f5[0] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_UnCorrelate_Pseudo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_51.root");        f5[1] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_UnCorrelate_Pseudo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_52.root");                                                                                                                                     
  f5[2] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_UnCorrelate_Pseudo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_53.root");                                                                                                                                         
  f5[3] = new TFile("./Out_EmulatorRuns/D86/Out_emuRuns_D86_UnCorrelate_Pseudo_BX_100k_defaultConfig_hitScaleAdditive_20per_case_5.root");    \
  ...
  for(int i_file=0; i_file<11;i_file++)
    {
