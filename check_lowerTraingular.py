...
corr1 = np.loadtxt(corr_file)#"/home/work/kalpana1/public/BE_DAQ_HGCAL_22/CMSSW_10_2_0_pre3/src/inputs/v1_correlationMatrix_15kby15k_LatestNtuples_D86_Fe10.txt")#PseudoEventMachinery/CoVMatrix_15kby15k_LatestNtuples_D86_Fe10_w100k.txt")
corr2 = np.loadtxt(lt_file) #"/home/work/kalpana1/public/BE_DAQ_HGCAL_22/CMSSW_10_2_0_pre3/src/PseudoEventMachinery/CoVMatrix_15kby15k_RandGaussian_D86_Fe10_w100k_04Mar23.txt")#inputs/v1_correlationMatrix_15kby15k_LatestNtuples_D86_Fe10.txt")#LowerDecomMatrix_correlationMatrix_15kby15k_LatestNtuples_D86_Fe10.txt")
# corr1[corr1 == -inf] = 0.1
# corr1[~np.isfinite(corr1)] = 0.1
L1=la.cholesky(corr1, lower=True)
#print(L1,'orig')
print(L1==corr2)
print(np.matmul(corr2,np.transpose(corr2)),"after")  
print(corr1,'orig')
