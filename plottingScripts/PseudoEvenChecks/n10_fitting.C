...
void n10_fitting(string root_file_name,string map_file, string pathname, string tagname, string tagname1, string tagname2, string outfile)
{
...
char* hname3 = new char[2000];
  ...
  for(int iModule = 0; iModule<length;iModule++)
    {
      ...
      sprintf(hist_name,"trans_hits_%s_%d_%d_%d_%d",tagname2.c_str(),map_vec[iModule].layer,map_vec[iModule].type,map_vec[iModule].u,map_vec[iModule].v);
      if (map_vec[iModule].layer ==33 && map_vec[iModule].u ==1 && map_vec[iModule].v==10)
      	 {
 ...
 resp2->GetFunction("fit_func")->SetLineColor(kRed);
 	...
 	else if(map_vec[iModule].layer>=37 && map_vec[iModule].layer<=44)
 	    {
 	      ...
 	      resp2->SetLineWidth(2);
 	      TF1* func = new TF1("fit_func","([0]*TMath::Gaus(x,[1],[2])) + [3]*TMath::Poisson(x,[4])+[5]*TMath::Landau(x,[6],[7])");
	      if((map_vec[iModule].layer==39 && map_vec[iModule].u==3 && map_vec[iModule].v==2) ||(map_vec[iModule].layer==39 && map_vec[iModule].u==2 && map_vec[iModule].v==3) || (map_vec[iModule].layer==41 && map_vec[iModule].u==3 && map_vec[iModule].v==0))
		{
	...
	//if ((map_vec[iModule].u>=6 && map_vec[iModule].u<=8) && (map_vec[iModule].v>=6 &&map_vec[iModule].v<=8)) 
      	{
      	  ...
      	  else if(map_vec[iModule].layer>=22 && map_vec[iModule].layer<=42)
            {
              ...
              func->SetParameter(6,resp2->GetMean());//-0.5*resp2->GetMean());                                                                                                                          
              func->SetParameter(7,resp2->GetRMS());
	      if ((map_vec[iModule].layer ==41 && map_vec[iModule].u ==7 && map_vec[iModule].v==6))//&&(map_vec[iModule].layer ==42 && map_vec[iModule].u ==7 &&  map_vec[iModule].v==8))
		{
	      ...
	      else if (map_vec[iModule].layer ==42 && map_vec[iModule].u==7 &&  map_vec[iModule].v==8)
		{
		  func->SetParameter(0,2500);
		  func-> SetParameter(1,resp2->GetMean());
		  func->SetParameter(2,resp2->GetRMS());
	  ...
	  if(map_vec[iModule].layer<=13&&map_vec[iModule].layer>=1)
	    {
	      ...
	      Canvas_n2->SaveAs(full_path2);Canvas_n2->SaveAs(full_path3);
	  ...
	  else  if(map_vec[iModule].layer<=19 && map_vec[iModule].layer>=14)
            {
              ...
              func->SetParameter(7,resp2->GetRMS()-1);
	      if ((map_vec[iModule].layer ==15 && map_vec[iModule].u ==9 && map_vec[iModule].v==4))//||(map_vec[iModule].layer ==16 && ((map_vec[iModule].u ==2 && map_vec[iModule].v==9) || ( map_vec[iModule].u ==6 && map_vec[iModule].v==9) || ( map_vec[iModule].u ==7 && map_vec[iModule].v==9)|| ( map_vec[iModule].u ==9 && map_vec[iModule].v==7))))
		{
		  func->SetParameter(0,1000); 
		  func-> SetParameter(1,resp2->GetMean()); 
		  func->SetParameter(2,resp2->GetRMS());
	      ...
	      else if( (map_vec[iModule].layer ==16 && ((map_vec[iModule].u ==2 && map_vec[iModule].v==9) || ( map_vec[iModule].u ==6 && map_vec[iModule].v==9) || ( map_vec[iModule].u ==7 && map_vec[iModule].v==9)|| ( map_vec[iModule].u ==9 && map_vec[iModule].v==7)) )|| (map_vec[iModule].layer ==17 && ((map_vec[iModule].u ==8 && map_vec[iModule].v ==9)||(map_vec[iModule].u ==9 && map_vec[iModule].v ==3))) || (map_vec[iModule].layer ==18 &&((map_vec[iModule].u ==7 && map_vec[iModule].v ==9)|| (map_vec[iModule].u ==9 && map_vec[iModule].v ==4) || (map_vec[iModule].u ==9 && map_vec[iModule].v ==5))) || (map_vec[iModule].layer ==19 && map_vec[iModule].u ==9 && map_vec[iModule].v ==1))
		{
		  func->SetParameter(0,1000);
		  func-> SetParameter(1,resp2->GetMean());
		  func->SetParameter(2,resp2->GetRMS());
	      ...
	      if(r1<0){
	    ...
	    else if(map_vec[iModule].layer<=25 && map_vec[iModule].layer>=20)
            {
              ...
              func->SetParameter(6,resp2->GetMean()-2);//-0.5*resp2->GetMean());                                                                                                                           
              func->SetParameter(7,resp2->GetRMS());
	      if( map_vec[iModule].layer==23 && ((map_vec[iModule].u ==7 && map_vec[iModule].v ==10)||(map_vec[iModule].u ==10 && map_vec[iModule].v ==1)))
		{
		  ...
		  if(map_vec[iModule].layer==19 && map_vec[iModule].u==1 && map_vec[iModule].v ==6)
		  ...
		  else
		    {
              ...
              gStyle->SetOptFit(1);
	      	      ...
	      	      //func->SetParameter(6,resp2->GetMean());
	      	      func->SetParameter(7,resp2->GetRMS());
		      if(map_vec[iModule].layer==32 && map_vec[iModule].u==8 && map_vec[iModule].v==0)
			{
			  func->SetParameter(0,1000); 
			  func-> SetParameter(1,resp2->GetMean()); 
			  func->SetParameter(2,resp2->GetRMS());
              ...
              gStyle->SetOptFit(1);
	      	      ...
	      	      //func->SetParameter(6,resp2->GetMean());
	      	      func->SetParameter(7,resp2->GetRMS());
		      if((map_vec[iModule].layer==38 && map_vec[iModule].u==7 && map_vec[iModule].v==5)||(map_vec[iModule].layer==41 && map_vec[iModule].u==2 && map_vec[iModule].v==6))
			{
			  func->SetParameter(0,1000);
			  func-> SetParameter(1,resp2->GetMean());
			  func->SetParameter(2,resp2->GetRMS());
