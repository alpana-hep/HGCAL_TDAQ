...
L=la.cholesky(corl, lower=True) #np.linalg.cholesky(corr1) #,lower=True)
#la.cholesky(corr1+d*I, lower=True)

np.savetxt("/home/work/kalpana1/public/BE_DAQ_HGCAL_22/CMSSW_10_2_0_pre3/src/inputs/LowerTraingular_Matrix_numpy_method_15kby15k_LatestNtuples_D86_Fe10_corr.txt",L)
