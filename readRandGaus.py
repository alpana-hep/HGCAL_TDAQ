...
def readRandGaus(min_,max_,fin):
    gc.enable()
    gc.collect()
    L = np.loadtxt("/home/work/kalpana1/public/BE_DAQ_HGCAL_22/CMSSW_10_2_0_pre3/src/inputs/LowerDecomp_correlationMatrix_15kby15k_D49_defined.txt")
    # print(corr1)
    # corr1[corr1 == -inf] = 0.1
    ...
    nHalfHgcrocs=[]
    nMaxWords=[]
    data = np.loadtxt("/home/work/kalpana1/public/BE_DAQ_HGCAL_22/CMSSW_10_2_0_pre3/src/PseudoEventMachinery/luv_ncells_map_cmssw_D49_V9.txt")
