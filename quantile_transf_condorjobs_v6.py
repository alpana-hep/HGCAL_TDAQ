...
M=4851 #500 ## total number of modules                                                                                              
...
qt= QuantileTransformer(n_quantiles=60000, output_distribution='normal', random_state=0,subsample = 100000)
qt1= QuantileTransformer(n_quantiles=60000, output_distribution='normal', random_state=0,subsample = 100000)
